...
function Game() {
  ...
  return (
    <main className="flex items-center justify-center flex-col gap-8 p-4 max-w-sm w-full">
      <div className="flex gap-4 flex-col max-w-sm w-full rouded-lg mt-10 max-auto">
